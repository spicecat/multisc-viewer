...
import preprocessor, {
  sveltePreprocess,
} from "file:///home/ahteh/Developer/plot-viewer/node_modules/svelte-preprocess/dist/index.js";
import {
  compile,
  compileModule,
  preprocess,
} from "file:///home/ahteh/Developer/plot-viewer/node_modules/svelte/src/compiler/index.js";
                ...
                if (matches) {
                  ...
                  chunk.imports.forEach((id) => {
                    if (id.startsWith("assets/")) {
                      ...
                      const correction =
                        new Array(routeNesting).fill("..").join("/") + "/";
                ...
                if (matches) {
                  ...
                  chunk.imports.forEach((id) => {
                    if (id.startsWith("assets/")) {
                      ...
                      const file = path.at(-1);
                      const correction =
                        routeNesting > importedNesting
                          ? new Array(routeNesting - importedNesting)
                              .fill("..")
                              .join("/") + "/"
                          : "./";
                      if (!file)
                      ...
                      chunk.code = chunk.code.replace(pattern, (match, id2) => {
                        return match.replace(
                          id2,
